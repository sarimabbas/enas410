...
const onview = (props) => {
    return (
        <Aux>
            <h1>On View</h1>
            <p></p>
            <img className={classNames("imageKing")} src="http://1.bp.blogspot.com/-RKkbHSKyBPI/T9FSM4MMLAI/AAAAAAAADLc/fdA1PEeoQtE/s1600/Marsh+PMGH3b.jpg" alt ="Great Hall"></img>
